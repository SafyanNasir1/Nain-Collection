...
export default function JhumkaDetailsPage() {
  ...
  // Styles included in the box — shown as a "What's Inside" breakdown.
  // If your data.ts has a `styles` array on the deal, that is used instead.
  const includedStyles: string[] = (deal as any).styles ?? [
    "Jhumki",
    "Chandbali",
    "Antique Danglers",
    "Kundan Studs",
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-start lg:gap-16">
            ...
            >
              ...
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[30px] border border-[#16302a]/8 bg-[#eeeade] shadow-[0_25px_70px_rgba(22,48,42,0.10)] sm:aspect-square lg:aspect-[4/5]">
                ...
                <div className="absolute right-5 top-5 z-20 flex flex-col items-center rounded-2xl border border-[#c9a227]/40 bg-white/85 px-3.5 py-2 text-center backdrop-blur-md shadow-lg">
                  <span className="font-serif text-lg leading-none text-[#16302a]">
                    {includedStyles.length}
                  </span>
                  <span className="mt-0.5 text-[7px] font-bold uppercase tracking-[0.15em] text-[#927d42]">
                    Pairs Inside
                  </span>
                </div>
              ...
              <div className="mt-7 rounded-2xl border border-[#16302a]/5 bg-white/70 p-5 sm:p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-7 text-[#6d685b]">
                      A beautifully curated jhumka box featuring{" "}
                      {includedStyles.length} handpicked earring styles — from
                      delicate jhumkis to bold antique danglers. Thoughtfully
                      arranged and packed to make a lasting impression, whether
                      you're treating yourself or gifting someone special.
                    </p>
                  </div>
                </div>
              </div>

              {/* WHAT'S INSIDE — STYLE CHIPS */}

              <div className="mt-4 rounded-2xl border border-[#16302a]/5 bg-white/70 p-5 sm:p-6">
                <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#927d42]">
                  What's Inside The Box
                </p>

                <div className="mt-3 flex flex-wrap gap-2">
                  {includedStyles.map((style) => (
                    <span
                      key={style}
                      className="rounded-full border border-[#16302a]/10 bg-[#f8f5ed] px-3.5 py-1.5 text-[10px] font-medium text-[#16302a] transition-colors duration-300 hover:border-[#c9a227]/50 hover:bg-[#c9a227]/10"
                    >
                      {style}
                    </span>
                  ))}
